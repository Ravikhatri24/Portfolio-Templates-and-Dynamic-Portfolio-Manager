...
<body style="background-color:white">
    ...
    <section id="whatido" style="background-color:whitesmoke;">
        ...
        <div class="conatiner-fluid">
            ...
            ?>
                        <div class="row" style="position:relative">
                            <div class="col-md-6 col-sm-6 col-xs-6  animate-box fadeInUp animated"
                                style="margin-bottom:8em; height:757px; background: url('images/<?php echo $row["boximage"]?>');
                                    background-size: cover; background-position: center center; background-repeat: no-repeat;">
                            </div>
                            <div class="col-md-6 col-sm-6 col-xs-6  animate-box fadeInUp animated">
                            </div>
                            <div class="worktitle animate-box fadeInUp animated" style="background-color:white">
                                <div class="ntitle2"> <?php echo $row['maintitle']; ?><br><br></div>
                                <h1> <strong><?php echo $row['boxtitle']; ?></strong><br><br></h1>
                                <div class="wtitle"><?php echo $row['boxdesc']; ?><br><br></div>
                            </div>
                        </div>
                    <?php 
                        }else{
