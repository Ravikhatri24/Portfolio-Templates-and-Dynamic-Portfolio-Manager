    ...
    <div class="container">
        <div class="row">
            <div class="addform">
                ...
                <br>
                <p>
                    <form method="post" action="addexperienceinsert.php">
                        <div class="form-group">
                        <label class="ntitle">Add New Experience</label>
                        <input  class="form-control" type="text" name="addexp" id="" placeholder="Enter new content">
                        </div>
                        <div class="form-group">
